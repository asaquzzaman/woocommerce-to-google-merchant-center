		...
		<table class="wp-list-table woogool-map-table widefat striped posts">
			<thead>
				<tr>
					...
					<th>Google Local Prducts Inventory Attributes</th>
...
<script>
	...
	export default {
		...
		data () {
			return {
				googleAttributes: woogool_multi_product_var.woogool_local_product_inventory_attrs,
		...
		watch: {
			'$route' (route) { 
	            if(route.name == 'google_inventory') { 
	            	this.setDefaultAttr();
	            }
	        }
		},
