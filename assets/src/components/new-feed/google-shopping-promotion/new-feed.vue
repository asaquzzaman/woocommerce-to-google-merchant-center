<template>
	<div class="woogool-new-feed-warp">
		...
		<form v-if="!loading" class="woogool-new-feed-form" action="" @submit.prevent="submit()" method="post">
			...
			<google-shopping-promotion v-show="stage.step == 'second'" :extAttr="extAttr" :gAttrs="gAttrs"  :stage="stage"></google-shopping-promotion>
...
<script>
	...
	import FormHeader from '@components/new-feed/google-shopping-promotion/form-header.vue'
	import FormContent from '@components/new-feed/google-shopping-promotion/form-google-shopping-promotion.vue'
	import FormLogic from '@components/new-feed/google-shopping-promotion/form-logic.vue'
	...
	export default {
		...
		watch: {
			'$route' (route, old) { 
                if(old.name === 'edit_google_shopping_promotion') {
                	this.feed_id = false;
		...
		components: {
			...
			'google-shopping-promotion': FormContent,
