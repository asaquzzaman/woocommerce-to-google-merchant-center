		...
		<table class="wp-list-table woogool-map-table widefat striped posts">
			<thead>
				<tr>
					...
					<th>Google Shopping promotion Attributes</th>
...
<script>
	...
	export default {
		...
		data () {
			return {
				googleAttributes: woogool_multi_product_var.woogool_shopping_promotion_attributes,
		...
		watch: {
			'$route' (route) { 
	            if(route.name == 'google_shopping_promotion') { 
	            	this.setDefaultAttr();
	            }
	        }
		},
