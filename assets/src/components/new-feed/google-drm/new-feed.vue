<template>
	<div class="woogool-new-feed-warp">
		...
		<form v-if="!loading" class="woogool-new-feed-form" action="" @submit.prevent="submit()" method="post">
			...
			<google-drm v-show="stage.step == 'second'" :extAttr="extAttr" :gAttrs="gAttrs"  :stage="stage"></google-drm>
...
<script>
	...
	import FormHeader from '@components/new-feed/google-drm/form-header.vue'
	import FormContent from '@components/new-feed/google-drm/form-google-drm.vue'
	import FormLogic from '@components/new-feed/google-drm/form-logic.vue'
