<template>
	<div class="woogool-new-feed-warp">
		...
		<form v-if="!loading" class="woogool-new-feed-form" action="" @submit.prevent="submit()" method="post">
			...
			<google-local v-show="stage.step == 'second'" :extAttr="extAttr" :gAttrs="gAttrs"  :stage="stage"></google-local>
...
<script>
	...
	import FormHeader from '@components/new-feed/google-local/form-header.vue'
	import FormContent from '@components/new-feed/google-local/form-google-local.vue'
	import FormLogic from '@components/new-feed/google-local/form-logic.vue'
