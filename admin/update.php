...
class WOGO_Admin_Update {
    ...
    public static function getInstance() {
        if( ! self::$instance ) {
            self::$instance = new WOGO_Admin_Update();
        }
    ...
    function license_enter_notice() {
        ...
        ?>
        <div class="error">
            <p><?php printf( __( 'Please <a href="%s">enter</a> your <strong>woocommerce to google merchant center</strong> plugin license key to get regular update and support.' ), admin_url( '/edit.php?post_type=product&page=product_wogo&tab=wogo_update' ) ); ?></p>
        </div>
        <?php
    }
    ...
    function license_check_notice() {
        ...
        ?>
        <div class="error">
            <p><strong><?php _e( 'Woocommerce to google merchant cener Error:', 'woogoo' ); ?></strong> <?php echo $error; ?></p>
        </div>
        <?php
    }
    ...
    function remove_update_notifications( $transient ) {
        $basefile = plugin_basename( WOOGOO_PATH . '/woogoo.php' );
    ...
    function get_current_plugin_info() {
        ...
        $plugin_data = get_plugin_data( dirname( dirname( __FILE__ ) ) . '/woogoo.php' );
